  ...
  return (
    <>
      ...
      <main className="bg-[#06070a] text-white">
          ...
          <div className="flex items-center justify-center bg-[#0a0a0d] px-6 py-14 sm:px-12 lg:px-16">
            <div className="w-full max-w-md">
              ...
              <p className="mt-8 text-base font-semibold">
                {doctor.city} · {doctor.experienceYears} years of experience
              </p>
              ...
              <div className="mt-10 rounded-xl bg-[#141417] p-5">
                ...
                <p className="mt-3 text-center text-sm font-semibold">
                  Get this class and {otherDoctors.length}+ more
                </p>
                <Link
                  href="#get-started"
        ...
        {/* ──────────────────────────────────────────────────────────── */}
        {/* SECTION 2 — Trailer + horizontal mentor rail                 */}
        {/* ──────────────────────────────────────────────────────────── */}
        <section
          id="trailer"
          ...
          <div className="mt-10 flex items-end justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-white/55">
                Included with a membership. And {otherDoctors.length}+ more
              </p>
            </div>
