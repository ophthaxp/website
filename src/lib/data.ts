...
export const SPECIALTY_TABS: { key: Specialty; label: string }[] = [
  { key: "all", label: "All" },
  { key: "cornea-ocular-surface", label: "Cornea & Ocular Surface" },
  { key: "phaco-refractive-surgery", label: "Phaco & Refractive Surgery" },
  { key: "retina-vitreo-retinal-surgery", label: "Retina & Vitreo-Retinal Surgery" },
  { key: "glaucoma", label: "Glaucoma" },
  { key: "pediatric-ophthalmology", label: "Pediatric Ophthalmology" },
  { key: "oculoplasty", label: "Oculoplasty" },
  { key: "ophthalmology-practice-mastery", label: "Ophthalmology Practice Mastery" },
];
...
export const DOCTORS: Doctor[] = [
  ...
  },
  {
    ...
    specialty: ["cornea-ocular-surface", "phaco-refractive-surgery"],
    city: "Chennai",
    experienceYears: 24,
    imageUrl: PORTRAIT_F,
  ...
  },
  {
    ...
    specialty: ["glaucoma", "ophthalmology-practice-mastery"],
    city: "Pune",
    experienceYears: 19,
    imageUrl: PORTRAIT_M,
  ...
  },
  {
    ...
    specialty: ["ophthalmology-practice-mastery"],
    city: "Hyderabad",
    experienceYears: 22,
    imageUrl: PORTRAIT_F,
  ...
  },
  {
    ...
    specialty: ["cornea-ocular-surface", "ophthalmology-practice-mastery"],
    city: "Lucknow",
    experienceYears: 18,
    imageUrl: PORTRAIT_M,
  ...
  },
  {
    ...
    specialty: ["phaco-refractive-surgery", "ophthalmology-practice-mastery"],
    city: "Ahmedabad",
    experienceYears: 21,
    imageUrl: PORTRAIT_F,
